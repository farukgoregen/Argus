...
export function PriceTrendChart() {
  ...
  useEffect(() => {
    setMounted(true)
    // Debug: Log the data to confirm it's correct
    console.log("PriceTrendChart data:", mockPriceTrends)
  }, [])
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Line
                ...
                strokeWidth={2}
                name="Amazon"
                dot={{ r: 4, fill: CHART_COLORS.amazon }}
                activeDot={{ r: 6 }}
                connectNulls
              />
              <Line
                ...
                strokeWidth={2}
                name="Alibaba"
                dot={{ r: 4, fill: CHART_COLORS.alibaba }}
                activeDot={{ r: 6 }}
                connectNulls
              />
              <Line
                ...
                strokeWidth={2}
                name="Trendyol"
                dot={{ r: 4, fill: CHART_COLORS.trendyol }}
                activeDot={{ r: 6 }}
                connectNulls
              />
              <Line
                ...
                strokeWidth={2}
                name="DHGate"
                dot={{ r: 4, fill: CHART_COLORS.dhgate }}
                activeDot={{ r: 6 }}
                connectNulls
              />
            </LineChart>
